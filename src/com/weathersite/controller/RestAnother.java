...
//	              .toString();
        ...
        //example query params: ?q=Turku&cnt=10&mode=json&units=metric
		  //http://api.openweathermap.org/data/2.5/weather?q=London&appid=5faf668d624cabafa8f6c70ff24f3730
		  WebTarget target = client.target(
                "http://api.openweathermap.org/data/2.5/weather").queryParam("q", "london")
                .queryParam("appid", "5faf668d624cabafa8f6c70ff24f3730")
                ;

//		  ForecastResponse fr = target.request(MediaType.APPLICATION_JSON)
//	                .get(ForecastResponse.class);
		  
		  String path = target.request(MediaType.TEXT_PLAIN)
	                .get(String.class);; 
//	    String plainAnswer = 
